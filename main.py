...
def retrain_actuals(forecast_days):
    ...
    *Dont generate python code just give dates and anomlay*'''
    ...
    Output format:
    News agent summary with all tables present in it
    Insights agent summary with all tables present in it
    Weekly analysis agent summary with all tables present in it
    agent anomaly summary with all tables present in it
